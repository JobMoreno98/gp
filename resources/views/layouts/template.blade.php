...
<body>
	<!--Inicio nav-->
	<nav class="navbar fixed-top navbar-expand-lg container-fluid" id="ftco-navbar" style="background-color: rgba(243, 205, 182, .9);">
		<div class="container-fluid d-flex align-items-center">
			<div class="col-lg-3 col-md-12 col-sm-12 mx-auto d-flex align-items-center container-fluid">
				<a class="navbar-brand mx-auto d-flex" target="_blank" href="https://www.udg.mx">
					<img src="images/1-logo_udg.svg" style="height: 65px;">
				</a>

				<a class="navbar-brand mx-auto d-flex" target="_blank" href="http://www.cucsh.udg.mx">
					<img src="images/cucsh.svg" style="height: 65px; padding: right 10px;">
				</a>
				<a class="navbar-brand mx-auto d-flex" href="">
					<img src="images/globalpolitics.svg" class="{{route('index')}}" style="height: 75px;">
				</a>
...
<!--
	...
	<footer class="ftco-footer  ftco-section">
		<div class="container d-flex mx-auto">
			<div class="row mb-5">
				<img src="images/1-logo_udg.svg" style="padding-right: 3%; height: 250px;" class="float-left">
